...
import top.slantech.yzlibrary.adapter.FaceAdapter;
import top.slantech.yzlibrary.adapter.ViewPagerAdapter;
import top.slantech.yzlibrary.bean.ChatEmoji;
import top.slantech.yzlibrary.utils.FaceConversionUtil;
import top.slantech.yzlibrary.utils.KeyBoardUtils;
 ...
 *
 * 显示数据
 * SpannableString spannableString = FaceConversionUtil.getInstace().getExpressionString(MainActivity.this, mEditTextContent.getText().toString());
 tvMes.setText(spannableString);
 * *****************************************
 *
 * 带表情的自定义输入框
 * *****************************************
...
public class FaceRelativeLayout extends RelativeLayout implements
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.et_sendmessage) {
            // 隐藏表情选择框
            if (view.getVisibility() == View.VISIBLE) {
                hideFace();
            }
    ...
    private void showFace(){
        ...
        // 设置表情图片 为 键盘
        ivFace.setImageResource(R.drawable.icon_key);
        // 隐藏 键盘

        KeyBoardUtils.closeSoftInput(et_sendmessage,context);
    }
    ...
    private void hideFace(){
        ...
        KeyBoardUtils.showSoftInput(et_sendmessage,context);
    }
    ...
    private void Init_View() {
        ...
        ivFace = (ImageView) findViewById(R.id.btn_face);
